...
public class ArtistRecommendationRepositoryTest {
    ...
    public void setUp() {
        ...
        artistRecommendation1 = artistRecommendationRepository.save(new ArtistRecommendation());
        artistRecommendation2 = artistRecommendationRepository.save(new ArtistRecommendation());
