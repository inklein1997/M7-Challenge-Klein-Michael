...
public class ServiceLayerTest {
    ...
    public void setUpTrackRepositoryMock() {
        ...
        Track track1 = new Track(1, 1, "All Too Well", 5,1, LocalDate.of(2012,10,12));
        Track track2 = new Track(2, 1, "22", 3,1, LocalDate.of(2012,10,12));
    ...
    public void shouldReturnTrackById() {
        expectedTrack = new Track(1, 1, "All Too Well", 5,1, LocalDate.of(2012,10,12));
    ...
    public void shouldCreateAndReturnTrack() {
        expectedTrack = new Track(1, 1, "All Too Well", 5,1, LocalDate.of(2012,10,12));
        actualTrack = serviceLayer.createTrack(new Track(1, 1, "All Too Well", 5,1, LocalDate.of(2012,10,12)));
