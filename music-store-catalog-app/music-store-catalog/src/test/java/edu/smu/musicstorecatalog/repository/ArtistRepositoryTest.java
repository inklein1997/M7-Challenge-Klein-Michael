...
public class ArtistRepositoryTest {
    ...
    public void setUp() {
        ...
        artist1 = artistRepository.save(new Artist("Taylor Swift", "@taylorswift", "@taylorswift"));
        artist2 = artistRepository.save(new Artist("Imagine Dragons", "@imaginedragons", "@imaginedragons"));
